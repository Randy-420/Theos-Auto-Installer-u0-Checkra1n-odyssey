...
///////////////////////////////////////
	if (!(fp == NULL)) {
		while (fgets(chunk, sizeof(chunk), fp) != NULL) {
			if (!(((((((((strcmp(chunk, div) == 0) || (strcmp(chunk, div1) == 0)) || (strcmp(chunk, div2) == 0)) || (strcmp(chunk, div3) == 0)) || (strcmp(chunk, ttheos) == 0)) || (strcmp(chunk, nic) == 0)) || (strcmp(chunk, cd) == 0)) || (strcmp(chunk, mmake) == 0)) || (strcmp(chunk, old)==0))) {
				fputs(chunk, fw);
			}
		}
	}
